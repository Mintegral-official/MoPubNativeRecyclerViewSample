...
public class NativeRecyclerViewFragment extends Fragment {
    ...
    private String adUnitId = "11a17b188668469fb0412708c3d16813";//mopub native test id
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container,
        ...
        viewHolder.mLoadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (mRecyclerAdapter != null) {
                    mRecyclerAdapter.refreshAds(adUnitId, null);
                }
            }
        });
        ...
        mRecyclerAdapter.loadAds(adUnitId);
        return view;
    }
